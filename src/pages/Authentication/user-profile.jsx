...
const UserProfile = () => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      postal_code: Yup.string().length(
        6,
        postalCodeValidation.fixLength(CONSTANTS.PostalCode, 6)
      ),
      file: Yup.mixed()
        .nullable()
            ...
            <CardBody>
              ...
              <Row className="gy-3">
                <Col md={6}>
                  ...
                  <p>
                    {countries.find((c) => c.id === +userProfile.country)
                      ?.country_name || "-"}
                  </p>
                  ...
                  <p>
                    {states.find((s) => s.id === +userProfile.state)
                      ?.state_name || "-"}
                  </p>
                  ...
                  <p>
                    {cities.find((ci) => ci.id === +userProfile.city)
                      ?.city_name || "-"}
                  </p>
                </Col>
                    ...
                    <BaseSelectInput
                      ...
                      options={
                        stateLoading
                          ...
                          : [
                              {
                                label: selectLabel(CONSTANTS.State),
                                value: "",
                              },
                              ...states.map((s) => ({
                                label: s.state_name,
